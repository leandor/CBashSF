...
##    newMod.TES4.masters = Current[0].TES4.masters
    ...
    print "recType    :", newMod.TES4.recType
    print "size       :", newMod.TES4.size
...
def TestGMST():
    ...
    print "recType:", newRecord.recType
    print "size   :", newRecord.size
...
def TestSBSP():
    ...
    for record in Current.SBSP:
        ...
        print "sizeX :", record.sizeX
        print "sizeY :", record.sizeY
        print "sizeZ :", record.sizeZ
        break
    ...
    for record in Current.REGN:
        ...
        for entry in record.entries:
            ...
            for recObject in entry.objects:
                ...
                print "    sizeVar         :", recObject.sizeVar
...
def TestCELL():
    ...
    for record in Current.CELL:
        ...
        for achr in record.ACHR:
            ...
            print "  recType:", achr.recType
            print "  size   :", achr.size
        ...
        for acre in record.ACRE:
            ...
            print "  recType:", acre.recType
            print "  size   :", acre.size
        ...
        for refr in record.REFR:
            ...
            print "  recType:", refr.recType
            print "  size   :", refr.size
        ...
        if(pgrd != None):
            ...
            print "  recType:", pgrd.recType
            print "  size   :", pgrd.size
...
##print "Min:%.15f, Avg:%.15f, Max:%.15f" % (mini, avgi, maxi)
####eGMST
####testParams = [eGLOB, 0x53414C43, eFACT, eHAIR, eEYES, eRACE, eSOUN, eSKIL, eMGEF, eSCPT, eLTEX, 0x48434E45, 0x4C455053, eBSGN, eACTI, eAPPA, eARMO, eBOOK, eCLOT, eCONT, eDOOR, 0x52474E49, eLIGH, eMISC, eSTAT, eGRAS, eTREE, eFLOR, eFURN, eWEAP, eAMMO, eNPC_, eCREA, eLVLC, eSLGM, eKEYM, eALCH, eSBSP, eSGST, eLVLI, eWTHR, eCLMT, eREGN, eQUST, eIDLE, ePACK, eCSTY, eLSCR, eLVSP, eANIO, eWATR, eEFSH]
####print "Load"
####for nParam in testParams:
####    test = [Timer('MassTestLoad(%u)' % nParam, 'from __main__ import MassTestLoad').timeit(1) for x in range(0, 10)]
####    mini = min(test)
####    avgi = sum(test) / len(test)
####    print "Min:%.15f, Avg:%.15f"% (mini, avgi)
####print "Override"
####for nParam in testParams:
####    test = [Timer('MassTestOverride(%u)' % nParam, 'from __main__ import MassTestOverride').timeit(1) for x in range(0, 10)]
####    mini = min(test)
####    avgi = sum(test) / len(test)
####    print "Min:%.15f, Avg:%.15f"% (mini, avgi)
####print "New"
####for nParam in testParams:
####    test = [Timer('MassTestNew(%u)' % nParam, 'from __main__ import MassTestNew').timeit(1) for x in range(0, 10)]
####    mini = min(test)
####    avgi = sum(test) / len(test)
####    print "Min:%.15f, Avg:%.15f"% (mini, avgi)
####
