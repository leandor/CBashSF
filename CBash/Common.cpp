...
Function_NameType EntryPoint_NameInit[] =
    {
    Function_NameType(00,"Calculate Weapon Damage"),
    Function_NameType(01,"Calculate My Critical Hit Chance"),
    Function_NameType(02,"Calculate My Critical Hit Damage"),
    Function_NameType(03,"Calculate Weapon Attack AP Cost"),
    Function_NameType(04,"Calculate Mine Explode Chance"),
    Function_NameType(05,"Adjust Range Penalty"),
    Function_NameType(06,"Adjust Limb Damage"),
    Function_NameType(07,"Calculate Weapon Range"),
    Function_NameType(08,"Calculate To Hit Chance"),
    Function_NameType(09,"Adjust Experience Points"),
