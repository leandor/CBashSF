...
UINT32 ACRERecord::GetFieldAttribute(FIELD_IDENTIFIERS, UINT32 WhichAttribute)
    ...
    switch(FieldID)
        ...
        case 30: //xown Owner
            return FORMID_FIELD;
        case 31: //xrnk Faction rank
            return SINT32_FIELD;
        case 32: //xmrc Merchant Container
            return FORMID_FIELD;
        case 33: //xcnt Count
            return SINT32_FIELD;
        case 34: //xrds Radius
...
void * ACRERecord::GetField(FIELD_IDENTIFIERS, void **FieldValues)
    ...
    switch(FieldID)
        ...
        case 30: //xown Owner
            return XOWN.IsLoaded() ? &XOWN->XOWN->value30 : NULL;
        case 31: //xrnk Faction rank
            return XOWN.IsLoaded() ? &XOWN->XRNK->value31 : NULL;
        case 32: //xmrc Merchant Container
            return XMRC.IsLoaded() ? &XMRC->value32 : NULL;
        case 33: //xcnt Count
            return XCNT.IsLoaded() ? &XCNT->value33 : NULL;
        case 34: //xrds Radius
            return XRDS.IsLoaded() ? &XRDS->value34 : NULL;
        case 35: //xhlp Health
            return XHLP.IsLoaded() ? &XHLP->value35 : NULL;
        case 36: //xdcr XDCR ,, Struct
        ...
        case 46: //xclp_p XCLP ,, Struct
            *FieldValues = XCLP.IsLoaded() ? &XCLP->value46[0] : NULL;
            return NULL;
        case 47: //xapd Flags
            return XAPD.IsLoaded() ? &XAPD->XAPD->value47 : NULL;
        case 48: //xapr XAPR ,, Struct
...
bool ACRERecord::SetField(FIELD_IDENTIFIERS, void *FieldValue, UINT32 ArraySize)
    ...
    switch(FieldID)
        ...
        case 30: //xown Owner
            XOWN.Load();
            XOWN->XOWN.Load();
            XOWN->XOWN->value30 = *(FORMID *)FieldValue;
            return true;
        case 31: //xrnk Faction rank
            XOWN.Load();
            XOWN->XRNK.Load();
            XOWN->XRNK->value31 = *(SINT32 *)FieldValue;
            break;
        case 32: //xmrc Merchant Container
            XMRC.Load();
            XMRC->value32 = *(FORMID *)FieldValue;
            return true;
        case 33: //xcnt Count
            XCNT.Load();
            XCNT->value33 = *(SINT32 *)FieldValue;
            break;
        case 34: //xrds Radius
            XRDS.Load();
            XRDS->value34 = *(FLOAT32 *)FieldValue;
            break;
        case 35: //xhlp Health
            XHLP.Load();
            XHLP->value35 = *(FLOAT32 *)FieldValue;
            break;
        case 36: //xdcr XDCR ,, Struct
            XDCR.Load();
        ...
        case 42: //xclp_p XCLP ,, Struct
            if(ArraySize != 1)
                break;
            XCLP.Load();
            XCLP->value42[0] = ((UINT8ARRAY)FieldValue)[0];
            break;
        case 43: //xclp XCLP ,, Struct
            XCLP.Load();
        ...
        case 46: //xclp_p XCLP ,, Struct
            if(ArraySize != 1)
                break;
            XCLP.Load();
            XCLP->value46[0] = ((UINT8ARRAY)FieldValue)[0];
            break;
        case 47: //xapd Flags
            XAPD.Load();
            XAPD->XAPD.Load();
            XAPD->XAPD->value47 = *(UINT8 *)FieldValue;
            break;
        case 48: //xapr XAPR ,, Struct
            XAPR.Load();
        ...
        case 53: //xesp_p Enable Parent
            if(ArraySize != 3)
                break;
            XESP.Load();
            XESP->value53[0] = ((UINT8ARRAY)FieldValue)[0];
            XESP->value53[1] = ((UINT8ARRAY)FieldValue)[1];
            XESP->value53[2] = ((UINT8ARRAY)FieldValue)[2];
            break;
        case 54: //xemi Emittance
            XEMI.Load();
