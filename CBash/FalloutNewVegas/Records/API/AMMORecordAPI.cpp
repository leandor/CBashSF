...
bool AMMORecord::SetField(FIELD_IDENTIFIERS, void *FieldValue, UINT32 ArraySize)
    ...
    switch(FieldID)
        ...
        case 32: //value
            ...
            break;
        case 33: //clipRounds
            DATA.value.clipRounds = *(UINT8 *)FieldValue;
            break;
        case 34: //projectilesPerShot
            DAT2.Load();
            DAT2->projectilesPerShot = *(UINT32 *)FieldValue;
            break;
        case 35: //projectile
            DAT2.Load();
        ...
        case 36: //weight
            DAT2.Load();
            DAT2->weight = *(FLOAT32 *)FieldValue;
            break;
        case 37: //consumedAmmo
            DAT2.Load();
        ...
        case 38: //consumedPercentage
            DAT2.Load();
            DAT2->consumedPercentage = *(FLOAT32 *)FieldValue;
            break;
        case 39: //shortName
