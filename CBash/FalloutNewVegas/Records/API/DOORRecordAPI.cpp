...
UINT32 DOORRecord::GetFieldAttribute(FIELD_IDENTIFIERS, UINT32 WhichAttribute)
    ...
    switch(FieldID)
        ...
        case 33: //snam Sound - Open
            return FORMID_FIELD;
        case 34: //anam Sound - Close
            return FORMID_FIELD;
        case 35: //bnam Sound - Looping
            return FORMID_FIELD;
        case 36: //fnam Flags
            return UINT8_FIELD;
        default:
...
void * DOORRecord::GetField(FIELD_IDENTIFIERS, void **FieldValues)
    ...
    switch(FieldID)
        ...
        case 34: //anam Sound - Close
            return ANAM.IsLoaded() ? &ANAM->value34 : NULL;
        case 35: //bnam Sound - Looping
            return BNAM.IsLoaded() ? &BNAM->value35 : NULL;
        case 36: //fnam Flags
...
bool DOORRecord::SetField(FIELD_IDENTIFIERS, void *FieldValue, UINT32 ArraySize)
    ...
    switch(FieldID)
        ...
        case 34: //anam Sound - Close
            ANAM.Load();
            ANAM->value34 = *(FORMID *)FieldValue;
            return true;
        case 35: //bnam Sound - Looping
            BNAM.Load();
            BNAM->value35 = *(FORMID *)FieldValue;
            return true;
        case 36: //fnam Flags
            FNAM.Load();
            FNAM->value36 = *(UINT8 *)FieldValue;
            break;
        default:
            break;
        }
