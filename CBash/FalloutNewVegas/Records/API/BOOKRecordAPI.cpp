...
bool BOOKRecord::SetField(FIELD_IDENTIFIERS, void *FieldValue, UINT32 ArraySize)
    ...
    switch(FieldID)
        ...
        case 25: //dest_p Header
            ...
            DEST.Load();
            DEST->DEST.Load();
            DEST->DEST->value25[0] = ((UINT8 *)FieldValue)[0];
            DEST->DEST->value25[1] = ((UINT8 *)FieldValue)[1];
            break;
        case 26: //dstd Destruction Stage Data
            DEST.Load();
            DEST->DSTD.Load();
        ...
        case 36: //data DATA ,, Struct
            DATA.Load();
            DATA->value36 = *(UINT8 *)FieldValue;
            break;
        case 37: //data DATA ,, Struct
            DATA.Load();
            DATA->value37 = *(SINT8 *)FieldValue;
            break;
        case 38: //data DATA ,, Struct
            DATA.Load();
            DATA->value38 = *(SINT32 *)FieldValue;
            break;
        case 39: //data DATA ,, Struct
            DATA.Load();
