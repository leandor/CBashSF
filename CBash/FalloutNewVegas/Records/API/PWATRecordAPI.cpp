...
namespace FNV
{
UINT32 PWATRecord::GetFieldAttribute(FIELD_IDENTIFIERS, UINT32 WhichAttribute)
    {
    switch(FieldID)
        {
        case 0: //recType
...
bool PWATRecord::SetField(FIELD_IDENTIFIERS, void *FieldValue, UINT32 ArraySize)
    {
    switch(FieldID)
        {
        case 1: //flags1
        ...
        case 17: //dnam DNAM ,, Struct
            DNAM.Load();
            DNAM->value17 = *(UINT32 *)FieldValue;
            break;
        case 18: //dnam DNAM ,, Struct
            DNAM.Load();
            DNAM->value18 = *(FORMID *)FieldValue;
            return true;
        default:
            break;
        }
