...
signed long SOUNRecord::GetOtherFieldType(const unsigned long Field)
    {
    switch(Field)
        {
        case 6: //soundFile
...
void * SOUNRecord::GetOtherField(const unsigned long Field)
    {
    switch(Field)
        {
        case 5: //eid
...
unsigned long SOUNRecord::GetFieldArraySize(const unsigned long Field)
    {
    switch(Field)
        {
        case 10: //unused1
...
void SOUNRecord::GetFieldArray(const unsigned long Field, void **FieldValues)
    {
    switch(Field)
        {
        case 10: //unused1
...
void SOUNRecord::SetField(const unsigned long Field, char *FieldValue)
    {
    switch(Field)
        {
        case 5: //eid
...
void SOUNRecord::SetField(const unsigned long Field, unsigned char FieldValue)
    {
    switch(Field)
        {
        case 7: //minDistance
...
void SOUNRecord::SetField(const unsigned long Field, unsigned short FieldValue)
    {
    switch(Field)
        {
        case 11: //flags
...
void SOUNRecord::SetField(const unsigned long Field, unsigned char *FieldValue, unsigned long nSize)
    {
    switch(Field)
        {
        case 10: //unused1
...
void SOUNRecord::SetField(const unsigned long Field, short FieldValue)
    {
    switch(Field)
        {
        case 13: //staticAtten
...
signed long SOUNRecord::DeleteField(const unsigned long Field)
    {
