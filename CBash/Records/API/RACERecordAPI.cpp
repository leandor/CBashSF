...
signed long RACERecord::CreateListElement(const unsigned long subField)
    {
    ...
    switch(subField)
        ...
        case 9: //relations
            ...
            return (signed long)XNAM.size() - 1;
        default:
            return -1;
        }
    }

signed long RACERecord::DeleteListElement(const unsigned long subField)
    {
    ReqSubRecord<GENXNAM> *curXNAM = NULL;
    switch(subField)
        {
...
signed long RACERecord::GetOtherFieldType(const unsigned long Field)
    {
    switch(Field)
        {
        case 6: //full
...
void * RACERecord::GetOtherField(const unsigned long Field)
    {
    switch(Field)
        {
        case 5: //eid
...
unsigned long RACERecord::GetFieldArraySize(const unsigned long Field)
    {
    switch(Field)
        {
        case 8: //spells
        ...
        case 99: //femaleTail_modt_p
            ...
            return 0;
        case 105: //hairs
            return (unsigned long)HNAM.size();
        case 106: //eyes
            return (unsigned long)ENAM.size();
        case 107: //fggs_p
            return FGGS.GetSize();
        case 108: //fgga_p
            return FGGA.GetSize();
...
void RACERecord::GetFieldArray(const unsigned long Field, void **FieldValues)
    {
    switch(Field)
        {
        case 8: //spells
...
signed long RACERecord::GetListFieldType(const unsigned long subField, const unsigned long listField)
    {
    switch(subField)
        {
        case 9: //relations
...
unsigned long RACERecord::GetListSize(const unsigned long Field)
    {
    switch(Field)
        {
        case 9: //relations
            return (unsigned long)XNAM.size();
        default:
            return 0;
        }
    }

void * RACERecord::GetListField(const unsigned long subField, const unsigned long listIndex, const unsigned long listField)
    {
    switch(subField)
        {
        case 9: //relations
...
void RACERecord::SetField(const unsigned long Field, char *FieldValue)
    {
    switch(Field)
        {
        case 5: //eid
...
void RACERecord::SetField(const unsigned long Field, unsigned long FieldValue[], unsigned long nSize)
    {
    switch(Field)
        {
        case 8: //spells
...
void RACERecord::SetListField(const unsigned long subField, const unsigned long listIndex, const unsigned long listField, signed long FieldValue)
    {
    switch(subField)
        {
        case 9: //relations
...
void RACERecord::SetListField(const unsigned long subField, const unsigned long listIndex, const unsigned long listField, unsigned long FieldValue)
    {
    switch(subField)
        {
        case 9: //relations
...
void RACERecord::SetField(const unsigned long Field, unsigned char *FieldValue, unsigned long nSize)
    {
    switch(Field)
        {
        case 24: //unused1
...
void RACERecord::SetField(const unsigned long Field, float FieldValue)
    {
    switch(Field)
        {
        case 25: //maleHeight
...
void RACERecord::SetOtherField(const unsigned long Field, unsigned long FieldValue)
    {
    switch(Field)
        {
        case 29: //flags
...
void RACERecord::SetField(const unsigned long Field, unsigned char FieldValue)
    {
    switch(Field)
        {
        case 34: //defaultHairColor
...
signed long RACERecord::DeleteField(const unsigned long Field)
    {
...
signed long RACERecord::DeleteListField(const unsigned long subField, const unsigned long listIndex, const unsigned long listField)
    {
    GENXNAM defaultXNAM;
    switch(subField)
        {
