...
signed long WTHRRecord::CreateListElement(const unsigned long subField)
    {
...
signed long WTHRRecord::DeleteListElement(const unsigned long subField)
    {
    ReqSubRecord<WTHRSNAM> *curSNAM = NULL;
    switch(subField)
        {
...
signed long WTHRRecord::GetOtherFieldType(const unsigned long Field)
    {
    switch(Field)
        {
        case 6: //lowerLayer
...
void * WTHRRecord::GetOtherField(const unsigned long Field)
    {
    switch(Field)
        {
        case 5: //eid
...
unsigned long WTHRRecord::GetFieldArraySize(const unsigned long Field)
    {
    switch(Field)
        {
        case 10: //modt_p
...
void WTHRRecord::GetFieldArray(const unsigned long Field, void **FieldValues)
    {
    switch(Field)
        {
        case 10: //modt_p
...
signed long WTHRRecord::GetListFieldType(const unsigned long subField, const unsigned long listField)
    {
    switch(subField)
        {
        case 204: //sounds
...
unsigned long WTHRRecord::GetListSize(const unsigned long Field)
    {
    switch(Field)
        {
        case 204: //sounds
...
void * WTHRRecord::GetListField(const unsigned long subField, const unsigned long listIndex, const unsigned long listField)
    {
    switch(subField)
        {
        case 204: //sounds
...
void WTHRRecord::SetField(const unsigned long Field, char *FieldValue)
    {
    switch(Field)
        {
        case 5: //eid
...
void WTHRRecord::SetField(const unsigned long Field, float FieldValue)
    {
    switch(Field)
        {
        case 9: //modb
...
void WTHRRecord::SetField(const unsigned long Field, unsigned char *FieldValue, unsigned long nSize)
    {
    switch(Field)
        {
        case 10: //modt_p
...
void WTHRRecord::SetField(const unsigned long Field, unsigned char FieldValue)
    {
    switch(Field)
        {
        case 11: //upperSky.rise.red
...
void WTHRRecord::SetListField(const unsigned long subField, const unsigned long listIndex, const unsigned long listField, unsigned long FieldValue)
    {
    switch(subField)
        {
        case 204: //sounds
...
signed long WTHRRecord::DeleteField(const unsigned long Field)
    {
    GENCLR defaultCLR;
...
signed long WTHRRecord::DeleteListField(const unsigned long subField, const unsigned long listIndex, const unsigned long listField)
    {
