...
signed long CREARecord::CreateListElement(const unsigned long subField)
    {
    ...
    switch(subField)
        ...
        case 20: //factions
            ...
            return (signed long)SNAM.size() - 1;
        case 23: //items
            curCNTO = new ReqSubRecord<GENCNTO>;
            CNTO.push_back(curCNTO);
            return (signed long)CNTO.size() - 1;
        case 59: //sounds
            curSound = new CREASound;
            Sounds.push_back(curSound);
            return (signed long)Sounds.size() - 1;
        default:
            return -1;
        }
    }

signed long CREARecord::DeleteListElement(const unsigned long subField)
    {
    ReqSubRecord<GENSNAM> *curSNAM = NULL;
    ReqSubRecord<GENCNTO> *curCNTO = NULL;
    CREASound *curSound = NULL;
...
signed long CREARecord::GetOtherFieldType(const unsigned long Field)
    {
    switch(Field)
        {
        case 6: //full
...
void * CREARecord::GetOtherField(const unsigned long Field)
    {
    switch(Field)
        {
        case 5: //eid
...
unsigned long CREARecord::GetFieldArraySize(const unsigned long Field)
    {
    switch(Field)
        {
        case 9: //modt_p
        ...
        case 11: //bodyParts
            return (unsigned long)NIFZ.size();
        case 12: //nift_p
            return NIFT.size;
        case 31: //unused1
            return 2;
        case 32: //aiPackages
            return (unsigned long)PKID.size();
        case 33: //animations
            return (unsigned long)KFFZ.size();
        case 39: //unused2
            return 1;
        case 41: //unused3
            return 2;
...
void CREARecord::GetFieldArray(const unsigned long Field, void **FieldValues)
    {
    switch(Field)
        {
        case 9: //modt_p
...
signed long CREARecord::GetListFieldType(const unsigned long subField, const unsigned long listField)
    {
    switch(subField)
        {
        case 20: //factions
...
unsigned long CREARecord::GetListSize(const unsigned long Field)
    {
    switch(Field)
        {
        case 20: //factions
            return (unsigned long)SNAM.size();
        case 23: //items
            return (unsigned long)CNTO.size();
        case 59: //sounds
            return (unsigned long)Sounds.size();
        default:
            return 0;
        }
    }

unsigned long CREARecord::GetListArraySize(const unsigned long subField, const unsigned long listIndex, const unsigned long listField)
    {
    switch(subField)
        {
        case 20: //factions
...
void CREARecord::GetListArray(const unsigned long subField, const unsigned long listIndex, const unsigned long listField, void **FieldValues)
    {
    switch(subField)
        {
        case 20: //factions
...
void * CREARecord::GetListField(const unsigned long subField, const unsigned long listIndex, const unsigned long listField)
    {
    switch(subField)
        {
        case 20: //factions
...
void CREARecord::SetField(const unsigned long Field, char *FieldValue)
    {
    switch(Field)
        {
        case 5: //eid
...
void CREARecord::SetField(const unsigned long Field, float FieldValue)
    {
    switch(Field)
        {
        case 8: //modb
...
void CREARecord::SetField(const unsigned long Field, unsigned char *FieldValue, unsigned long nSize)
    {
    switch(Field)
        {
        case 9: //modt_p
...
void CREARecord::SetOtherField(const unsigned long Field, unsigned long FieldValue)
    {
    switch(Field)
        {
        case 13: //flags
...
void CREARecord::SetField(const unsigned long Field, unsigned short FieldValue)
    {
    switch(Field)
        {
        case 14: //baseSpell
...
void CREARecord::SetField(const unsigned long Field, short FieldValue)
    {
    switch(Field)
        {
        case 17: //level
...
void CREARecord::SetListField(const unsigned long subField, const unsigned long listIndex, const unsigned long listField, unsigned long FieldValue)
    {
    switch(subField)
        {
        case 20: //factions
...
void CREARecord::SetListField(const unsigned long subField, const unsigned long listIndex, const unsigned long listField, unsigned char FieldValue)
    {
    switch(subField)
        {
        case 20: //factions
...
void CREARecord::SetListField(const unsigned long subField, const unsigned long listIndex, const unsigned long listField, signed long FieldValue)
    {
    switch(subField)
        {
        case 23: //items
...
void CREARecord::SetListField(const unsigned long subField, const unsigned long listIndex, const unsigned long listField, unsigned char *FieldValue, unsigned long nSize)
    {
    switch(subField)
        {
        case 20: //factions
...
void CREARecord::SetField(const unsigned long Field, unsigned long FieldValue[], unsigned long nSize)
    {
    switch(Field)
        {
        case 10: //spells
        ...
        case 32: //aiPackages
            ...
            if(nSize)
                ...
                for(unsigned long x = 0; x < nSize; x++)
                    {
                    PKID[x] = new unsigned long(FieldValue[x]);
                    }
                }
            break;
        default:
...
void CREARecord::SetField(const unsigned long Field, unsigned char FieldValue)
    {
    switch(Field)
        {
        case 24: //aggression
...
void CREARecord::SetField(const unsigned long Field, char **FieldValue, unsigned long nSize)
    {
    switch(Field)
        {
        case 11: //bodyParts
            ...
            if(nSize)
                ...
                for(unsigned long x = 0; x < nSize; x++)
                    {
                    NIFZ[x] = InsensitiveStringRecord(FieldValue[x]);
                    }
                }
            break;
        case 33: //animations
            ...
            if(nSize)
                ...
                for(unsigned long x = 0; x < nSize; x++)
                    {
                    KFFZ[x] = StringRecord(FieldValue[x]);
                    }
                }
            break;
        default:
...
signed long CREARecord::DeleteField(const unsigned long Field)
    {
    GENAIDT defaultAIDT;
    GENACBS defaultACBS;
    ...
    switch(Field)
        ...
        case 58: //bloodDecalPath
            ...
            break;
        case 59: //sounds
            nSize = (unsigned long)Sounds.size();
            for(unsigned long x = 0; x < nSize; x++)
                delete Sounds[x];
            Sounds.clear();
            break;
...
signed long CREARecord::DeleteListField(const unsigned long subField, const unsigned long listIndex, const unsigned long listField)
    {
    GENSNAM defaultSNAM;
    GENCNTO defaultCNTO;
    switch(subField)
