...
signed long LIGHRecord::GetOtherFieldType(const unsigned long Field)
    {
    switch(Field)
        {
        case 6: //modPath
...
void * LIGHRecord::GetOtherField(const unsigned long Field)
    {
    switch(Field)
        {
        case 5: //eid
...
unsigned long LIGHRecord::GetFieldArraySize(const unsigned long Field)
    {
    switch(Field)
        {
        case 8: //modt_p
...
void LIGHRecord::GetFieldArray(const unsigned long Field, void **FieldValues)
    {
    switch(Field)
        {
        case 8: //modt_p
...
void LIGHRecord::SetField(const unsigned long Field, char *FieldValue)
    {
    switch(Field)
        {
        case 5: //eid
...
void LIGHRecord::SetField(const unsigned long Field, float FieldValue)
    {
    switch(Field)
        {
        case 7: //modb
...
void LIGHRecord::SetField(const unsigned long Field, unsigned char *FieldValue, unsigned long nSize)
    {
    switch(Field)
        {
        case 8: //modt_p
...
void LIGHRecord::SetOtherField(const unsigned long Field, unsigned long FieldValue)
    {
    switch(Field)
        {
        case 9: //script
...
void LIGHRecord::SetField(const unsigned long Field, signed long FieldValue)
    {
    switch(Field)
        {
        case 12: //duration
...
void LIGHRecord::SetField(const unsigned long Field, unsigned char FieldValue)
    {
    switch(Field)
        {
        case 14: //red
...
signed long LIGHRecord::DeleteField(const unsigned long Field)
    {
