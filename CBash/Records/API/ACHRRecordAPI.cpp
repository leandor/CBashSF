...
signed long ACHRRecord::GetOtherFieldType(const unsigned long Field)
    {
    switch(Field)
        {
        case 6: //base
...
void * ACHRRecord::GetOtherField(const unsigned long Field)
    {
    switch(Field)
        {
        case 5: //eid
...
unsigned long ACHRRecord::GetFieldArraySize(const unsigned long Field)
    {
    switch(Field)
        {
        case 14: //unused1
...
void ACHRRecord::GetFieldArray(const unsigned long Field, void **FieldValues)
    {
    switch(Field)
        {
        case 14: //unused1
...
void ACHRRecord::SetField(const unsigned long Field, char *FieldValue)
    {
    switch(Field)
        {
        case 5: //eid
...
void ACHRRecord::SetOtherField(const unsigned long Field, unsigned long FieldValue)
    {
    switch(Field)
        {
        case 6: //base
...
void ACHRRecord::SetField(const unsigned long Field, float FieldValue)
    {
    switch(Field)
        {
        case 9: //lod1
...
void ACHRRecord::SetField(const unsigned long Field, unsigned char FieldValue)
    {
    switch(Field)
        {
        case 13: //parentFlags
...
void ACHRRecord::SetField(const unsigned long Field, unsigned char *FieldValue, unsigned long nSize)
    {
    switch(Field)
        {
        case 14: //unused1
...
signed long ACHRRecord::DeleteField(const unsigned long Field)
    {
    GENXESP defaultXESP;
    GENXLOD defaultXLOD;
