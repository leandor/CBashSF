...
signed long TREERecord::GetOtherFieldType(const unsigned long Field)
    {
    switch(Field)
        {
        case 6: //modPath
...
void * TREERecord::GetOtherField(const unsigned long Field)
    {
    switch(Field)
        {
        case 5: //eid
...
unsigned long TREERecord::GetFieldArraySize(const unsigned long Field)
    {
    switch(Field)
        {
        case 8: //modt_p
...
void TREERecord::GetFieldArray(const unsigned long Field, void **FieldValues)
    {
    switch(Field)
        {
        case 8: //modt_p
...
void TREERecord::SetField(const unsigned long Field, char *FieldValue)
    {
    switch(Field)
        {
        case 5: //eid
...
void TREERecord::SetField(const unsigned long Field, float FieldValue)
    {
    switch(Field)
        {
        case 7: //modb
...
void TREERecord::SetField(const unsigned long Field, unsigned char *FieldValue, unsigned long nSize)
    {
    switch(Field)
        {
        case 8: //modt_p
...
void TREERecord::SetField(const unsigned long Field, unsigned long FieldValue[], unsigned long nSize)
    {
    switch(Field)
        {
        case 10: //speedTree
...
void TREERecord::SetField(const unsigned long Field, signed long FieldValue)
    {
    switch(Field)
        {
        case 16: //shadowRadius
...
signed long TREERecord::DeleteField(const unsigned long Field)
    {
