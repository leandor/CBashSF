...
signed long ALCHRecord::CreateListElement(const unsigned long subField)
    {
...
signed long ALCHRecord::DeleteListElement(const unsigned long subField)
    {
    GENEffect *curEffect = NULL;
    switch(subField)
        {
...
signed long ALCHRecord::GetOtherFieldType(const unsigned long Field)
    {
    switch(Field)
        {
        case 6: //full
...
void * ALCHRecord::GetOtherField(const unsigned long Field)
    {
    switch(Field)
        {
        case 5: //eid
...
unsigned long ALCHRecord::GetFieldArraySize(const unsigned long Field)
    {
    switch(Field)
        {
        case 9: //modt_p
...
void ALCHRecord::GetFieldArray(const unsigned long Field, void **FieldValues)
    {
    switch(Field)
        {
        case 9: //modt_p
...
signed long ALCHRecord::GetListFieldType(const unsigned long subField, const unsigned long listField)
    {
    switch(subField)
        {
        case 16: //Effects
...
unsigned long ALCHRecord::GetListSize(const unsigned long Field)
    {
    switch(Field)
        {
        case 16: //Effects
...
unsigned long ALCHRecord::GetListArraySize(const unsigned long subField, const unsigned long listIndex, const unsigned long listField)
    {
    switch(subField)
        {
        case 16: //Effects
...
void ALCHRecord::GetListArray(const unsigned long subField, const unsigned long listIndex, const unsigned long listField, void **FieldValues)
    {
    switch(subField)
        {
        case 16: //Effects
...
void * ALCHRecord::GetListField(const unsigned long subField, const unsigned long listIndex, const unsigned long listField)
    {
    switch(subField)
        {
        case 16: //Effects
...
void ALCHRecord::SetField(const unsigned long Field, char *FieldValue)
    {
    switch(Field)
        {
        case 5: //eid
...
void ALCHRecord::SetField(const unsigned long Field, float FieldValue)
    {
    switch(Field)
        {
        case 8: //modb
...
void ALCHRecord::SetField(const unsigned long Field, unsigned char *FieldValue, unsigned long nSize)
    {
    switch(Field)
        {
        case 9: //modt_p
...
void ALCHRecord::SetOtherField(const unsigned long Field, unsigned long FieldValue)
    {
    switch(Field)
        {
        case 11: //script
...
void ALCHRecord::SetField(const unsigned long Field, signed long FieldValue)
    {
    switch(Field)
        {
        case 13: //value
...
void ALCHRecord::SetField(const unsigned long Field, unsigned char FieldValue)
    {
    switch(Field)
        {
        case 14: //flags
...
void ALCHRecord::SetListField(const unsigned long subField, const unsigned long listIndex, const unsigned long listField, unsigned long FieldValue)
    {
    switch(subField)
        {
        case 16: //Effects
...
void ALCHRecord::SetListField(const unsigned long subField, const unsigned long listIndex, const unsigned long listField, float FieldValue)
    {
    switch(subField)
        {
        case 16: //Effects
...
void ALCHRecord::SetListField(const unsigned long subField, const unsigned long listIndex, const unsigned long listField, unsigned char FieldValue)
    {
    switch(subField)
        {
        case 16: //Effects
...
void ALCHRecord::SetListField(const unsigned long subField, const unsigned long listIndex, const unsigned long listField, unsigned char *FieldValue, unsigned long nSize)
    {
    switch(subField)
        {
        case 16: //Effects
...
void ALCHRecord::SetListField(const unsigned long subField, const unsigned long listIndex, const unsigned long listField, char *FieldValue)
    {
    switch(subField)
        {
        case 16: //Effects
...
signed long ALCHRecord::DeleteField(const unsigned long Field)
    {
    GENENIT defaultENIT;
...
signed long ALCHRecord::DeleteListField(const unsigned long subField, const unsigned long listIndex, const unsigned long listField)
    {
    GENEFIT defaultEFIT;
    GENSCIT defaultSCIT;
