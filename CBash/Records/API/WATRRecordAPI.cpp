...
signed long WATRRecord::GetOtherFieldType(const unsigned long Field)
    {
    switch(Field)
        {
        case 6: //texture
...
void * WATRRecord::GetOtherField(const unsigned long Field)
    {
    switch(Field)
        {
        case 5: //eid
...
unsigned long WATRRecord::GetFieldArraySize(const unsigned long Field)
    {
    switch(Field)
        {
        case 25: //unused1
...
void WATRRecord::GetFieldArray(const unsigned long Field, void **FieldValues)
    {
    switch(Field)
        {
        case 25: //unused1
...
void WATRRecord::SetField(const unsigned long Field, char *FieldValue)
    {
    switch(Field)
        {
        case 5: //eid
...
void WATRRecord::SetField(const unsigned long Field, unsigned char FieldValue)
    {
    switch(Field)
        {
        case 7: //opacity
...
void WATRRecord::SetOtherField(const unsigned long Field, unsigned long FieldValue)
    {
    switch(Field)
        {
        case 10: //sound
...
void WATRRecord::SetField(const unsigned long Field, float FieldValue)
    {
    switch(Field)
        {
        case 11: //windVelocity
...
void WATRRecord::SetField(const unsigned long Field, unsigned char *FieldValue, unsigned long nSize)
    {
    switch(Field)
        {
        case 25: //unused1
...
void WATRRecord::SetField(const unsigned long Field, unsigned short FieldValue)
    {
    switch(Field)
        {
        case 46: //damage
...
signed long WATRRecord::DeleteField(const unsigned long Field)
    {
