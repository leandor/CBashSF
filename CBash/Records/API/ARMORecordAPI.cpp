...
signed long ARMORecord::GetOtherFieldType(const unsigned long Field)
    {
    switch(Field)
        {
        case 6: //full
...
void * ARMORecord::GetOtherField(const unsigned long Field)
    {
    switch(Field)
        {
        case 5: //eid
...
unsigned long ARMORecord::GetFieldArraySize(const unsigned long Field)
    {
    switch(Field)
        {
        case 13: //maleBody_modt_p
...
void ARMORecord::GetFieldArray(const unsigned long Field, void **FieldValues)
    {
    switch(Field)
        {
        case 13: //maleBody_modt_p
...
void ARMORecord::SetField(const unsigned long Field, char *FieldValue)
    {
    switch(Field)
        {
        case 5: //eid
...
void ARMORecord::SetOtherField(const unsigned long Field, unsigned long FieldValue)
    {
    switch(Field)
        {
        case 7: //script
...
void ARMORecord::SetField(const unsigned long Field, unsigned short FieldValue)
    {
    switch(Field)
        {
        case 9: //enchantPoints
...
void ARMORecord::SetField(const unsigned long Field, float FieldValue)
    {
    switch(Field)
        {
        case 12: //maleBody_modb
...
void ARMORecord::SetField(const unsigned long Field, unsigned char *FieldValue, unsigned long nSize)
    {
    switch(Field)
        {
        case 13: //maleBody_modt_p
...
signed long ARMORecord::DeleteField(const unsigned long Field)
    {
