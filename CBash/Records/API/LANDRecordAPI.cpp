...
signed long LANDRecord::CreateListElement(const unsigned long subField)
    {
    switch(subField)
        {
        case 12: //baseTextures
            BTXT.push_back(new ReqSubRecord<LANDGENTXT>);
            return (signed long)BTXT.size() - 1;
        case 13: //alphaLayers
            Layers.push_back(new LANDLAYERS());
            return (signed long)Layers.size() - 1;
        case 14: //vertexTextures
            VTEX.push_back(0);
            return (signed long)VTEX.size() - 1;
        default:
            return -1;
        }
    }

signed long LANDRecord::DeleteListElement(const unsigned long subField)
    {
    switch(subField)
        {
        case 12: //baseTextures
...
signed long LANDRecord::GetOtherFieldType(const unsigned long Field)
    {
...
void * LANDRecord::GetOtherField(const unsigned long Field)
    {
    switch(Field)
        {
        case 8: //heightOffset
...
signed long LANDRecord::GetListFieldType(const unsigned long subField, const unsigned long listField)
    {
    switch(subField)
        {
        case 12: //baseTextures
...
signed long LANDRecord::GetListX2FieldType(const unsigned long subField, const unsigned long listField, const unsigned long listX2Field)
    {
    switch(subField)
        {
        case 7: //normals
...
unsigned long LANDRecord::GetListSize(const unsigned long Field)
    {
    switch(Field)
        {
        case 12: //baseTextures
            return (unsigned long)BTXT.size();
        case 13: //alphaLayers
            return (unsigned long)Layers.size();
        case 14: //vertexTextures
            return (unsigned long)VTEX.size();
        default:
            return 0;
        }
    }
unsigned long LANDRecord::GetListX2Size(const unsigned long subField, const unsigned long listIndex, const unsigned long listField)
    {
    switch(subField)
        {
        case 7: //normals
        ...
        case 13: //alphaLayers
            ...
            switch(listField)
                {
                case 5: //opacities
                    return (unsigned long)Layers[listIndex]->VTXT.size();
                default:
                    return 0;
                }
        case 15: //Position
...
unsigned long LANDRecord::GetListArraySize(const unsigned long subField, const unsigned long listIndex, const unsigned long listField)
    {
    switch(subField)
        {
        case 12: //baseTextures
...
unsigned long LANDRecord::GetListX2ArraySize(const unsigned long subField, const unsigned long listIndex, const unsigned long listField, const unsigned long listX2Index, const unsigned long listX2Field)
    {
    switch(subField)
        {
        case 13: //alphaLayers
...
unsigned long LANDRecord::GetFieldArraySize(const unsigned long Field)
    {
    switch(Field)
        {
        case 6: //data_p
...
void LANDRecord::GetFieldArray(const unsigned long Field, void **FieldValues)
    {
    switch(Field)
        {
        case 6: //data
...
void LANDRecord::GetListArray(const unsigned long subField, const unsigned long listIndex, const unsigned long listField, void **FieldValues)
    {
    switch(subField)
        {
        case 12: //baseTextures
...
void LANDRecord::GetListX2Array(const unsigned long subField, const unsigned long listIndex, const unsigned long listField, const unsigned long listX2Index, const unsigned long listX2Field, void **FieldValues)
    {
    switch(subField)
        {
        case 13: //alphaLayers
...
void * LANDRecord::GetListField(const unsigned long subField, const unsigned long listIndex, const unsigned long listField)
    {
    switch(subField)
        {
        case 12: //baseTextures
...
void * LANDRecord::GetListX2Field(const unsigned long subField, const unsigned long listIndex, const unsigned long listField, const unsigned long listX2Index, const unsigned long listX2Field)
    {
        ...
        case 15: //Position
            ...
            switch(listX2Field)
                ...
                case 10: //alphaLayer1Opacity
                    ...
                    for(unsigned long x = 0; x < Layers.size(); ++x)
                        if(Layers[x]->ATXT.value.quadrant == curQuadrant && Layers[x]->ATXT.value.layer == 0)
                            for(unsigned long y = 0; y < Layers[x]->VTXT.size(); ++y)
...
void LANDRecord::SetField(const unsigned long Field, float FieldValue)
    {
    switch(Field)
        {
        case 8: //heightOffset
...
void LANDRecord::SetField(const unsigned long Field, unsigned char *FieldValue, unsigned long nSize)
    {
    switch(Field)
        {
        case 6: //data
...
void LANDRecord::SetListField(const unsigned long subField, const unsigned long listIndex, const unsigned long listField, unsigned long FieldValue)
    {
    switch(subField)
        {
        case 12: //baseTextures
...
void LANDRecord::SetListField(const unsigned long subField, const unsigned long listIndex, const unsigned long listField, unsigned char FieldValue)
    {
    switch(subField)
        {
        case 12: //baseTextures
...
void LANDRecord::SetListField(const unsigned long subField, const unsigned long listIndex, const unsigned long listField, unsigned char *FieldValue, unsigned long nSize)
    {
    switch(subField)
        {
        case 12: //baseTextures
...
void LANDRecord::SetListField(const unsigned long subField, const unsigned long listIndex, const unsigned long listField, short FieldValue)
    {
    switch(subField)
        {
        case 12: //baseTextures
...
void LANDRecord::SetListX2Field(const unsigned long subField, const unsigned long listIndex, const unsigned long listField, const unsigned long listX2Index, const unsigned long listX2Field, unsigned char FieldValue)
    {
    switch(subField)
        {
        case 7: //normals
...
void LANDRecord::SetListX2Field(const unsigned long subField, const unsigned long listIndex, const unsigned long listField, const unsigned long listX2Index, const unsigned long listX2Field, char FieldValue)
    {
    switch(subField)
        {
        case 9: //heights
...
void LANDRecord::SetListX2Field(const unsigned long subField, const unsigned long listIndex, const unsigned long listField, const unsigned long listX2Index, const unsigned long listX2Field, unsigned short FieldValue)
    {
    switch(subField)
        {
        case 13: //alphaLayers
...
void LANDRecord::SetListX2Field(const unsigned long subField, const unsigned long listIndex, const unsigned long listField, const unsigned long listX2Index, const unsigned long listX2Field, unsigned char *FieldValue, unsigned long nSize)
    {
    switch(subField)
        {
        case 13: //alphaLayers
...
void LANDRecord::SetListX2Field(const unsigned long subField, const unsigned long listIndex, const unsigned long listField, const unsigned long listX2Index, const unsigned long listX2Field, float FieldValue)
    {
...
void LANDRecord::SetListX2Field(const unsigned long subField, const unsigned long listIndex, const unsigned long listField, const unsigned long listX2Index, const unsigned long listX2Field, unsigned long FieldValue)
    {
    unsigned char curQuadrant;
