...
signed long INGRRecord::CreateListElement(const unsigned long subField)
    {
...
signed long INGRRecord::DeleteListElement(const unsigned long subField)
    {
    GENEffect *curEffect = NULL;
    switch(subField)
        {
...
signed long INGRRecord::GetOtherFieldType(const unsigned long Field)
    {
    switch(Field)
        {
        case 6: //full
        ...
        case 16: //Effects
            return LIST_FIELD;
        //OBME Fields
        case 17: //recordVersion
            return UBYTE_FIELD;
        case 18: //betaVersion
            return UBYTE_FIELD;
        case 19: //minorVersion
            return UBYTE_FIELD;
        case 20: //majorVersion
            return UBYTE_FIELD;
        case 21: //reserved
            return BYTES_FIELD;
        case 22: //datx_p
...
void * INGRRecord::GetOtherField(const unsigned long Field)
    {
    switch(Field)
        {
        case 5: //eid
...
unsigned long INGRRecord::GetFieldArraySize(const unsigned long Field)
    {
    switch(Field)
        {
        case 9: //modt_p
...
void INGRRecord::GetFieldArray(const unsigned long Field, void **FieldValues)
    {
    switch(Field)
        {
        case 9: //modt_p
...
signed long INGRRecord::GetListFieldType(const unsigned long subField, const unsigned long listField)
    {
    switch(subField)
        {
        case 16: //Effects
...
unsigned long INGRRecord::GetListSize(const unsigned long Field)
    {
    switch(Field)
        {
        case 16: //Effects
...
unsigned long INGRRecord::GetListArraySize(const unsigned long subField, const unsigned long listIndex, const unsigned long listField)
    {
    switch(subField)
        {
        case 16: //Effects
...
void INGRRecord::GetListArray(const unsigned long subField, const unsigned long listIndex, const unsigned long listField, void **FieldValues)
    {
    switch(subField)
        {
        case 16: //Effects
...
void * INGRRecord::GetListField(const unsigned long subField, const unsigned long listIndex, const unsigned long listField)
    {
    switch(subField)
        {
        case 16: //Effects
...
void INGRRecord::SetField(const unsigned long Field, char *FieldValue)
    {
    switch(Field)
        {
        case 5: //eid
...
void INGRRecord::SetField(const unsigned long Field, float FieldValue)
    {
    switch(Field)
        {
        case 8: //modb
...
void INGRRecord::SetField(const unsigned long Field, unsigned char *FieldValue, unsigned long nSize)
    {
    switch(Field)
        {
        case 9: //modt_p
...
void INGRRecord::SetOtherField(const unsigned long Field, unsigned long FieldValue)
    {
    switch(Field)
        {
        case 11: //script
...
void INGRRecord::SetField(const unsigned long Field, signed long FieldValue)
    {
    switch(Field)
        {
        case 13: //value
...
void INGRRecord::SetField(const unsigned long Field, unsigned char FieldValue)
    {
    switch(Field)
        {
        case 14: //flags
...
void INGRRecord::SetListField(const unsigned long subField, const unsigned long listIndex, const unsigned long listField, unsigned long FieldValue)
    {
    switch(subField)
        {
        case 16: //Effects
...
void INGRRecord::SetListField(const unsigned long subField, const unsigned long listIndex, const unsigned long listField, float FieldValue)
    {
    switch(subField)
        {
        case 16: //Effects
...
void INGRRecord::SetListField(const unsigned long subField, const unsigned long listIndex, const unsigned long listField, unsigned char FieldValue)
    {
    switch(subField)
        {
        case 16: //Effects
...
void INGRRecord::SetListField(const unsigned long subField, const unsigned long listIndex, const unsigned long listField, unsigned char *FieldValue, unsigned long nSize)
    {
    switch(subField)
        {
        case 16: //Effects
...
void INGRRecord::SetListField(const unsigned long subField, const unsigned long listIndex, const unsigned long listField, char *FieldValue)
    {
    switch(subField)
        {
        case 16: //Effects
...
signed long INGRRecord::DeleteField(const unsigned long Field)
    {
    GENENIT defaultENIT;
...
signed long INGRRecord::DeleteListField(const unsigned long subField, const unsigned long listIndex, const unsigned long listField)
    {
    GENEFIT defaultEFIT;
    GENSCIT defaultSCIT;
