...
signed long NPC_Record::CreateListElement(const unsigned long subField)
    {
...
signed long NPC_Record::DeleteListElement(const unsigned long subField)
    {
    ReqSubRecord<GENSNAM> *curSNAM = NULL;
    ReqSubRecord<GENCNTO> *curCNTO = NULL;
    switch(subField)
...
signed long NPC_Record::GetOtherFieldType(const unsigned long Field)
    {
    switch(Field)
        {
        case 6: //full
...
void * NPC_Record::GetOtherField(const unsigned long Field)
    {
    switch(Field)
        {
        case 5: //eid
...
unsigned long NPC_Record::GetFieldArraySize(const unsigned long Field)
    {
    switch(Field)
        {
        case 9: //modt_p
...
void NPC_Record::GetFieldArray(const unsigned long Field, void **FieldValues)
    {
    switch(Field)
        {
        case 9: //modt_p
...
signed long NPC_Record::GetListFieldType(const unsigned long subField, const unsigned long listField)
    {
    switch(subField)
        {
        case 17: //factions
...
unsigned long NPC_Record::GetListSize(const unsigned long Field)
    {
    switch(Field)
        {
        case 17: //factions
...
unsigned long NPC_Record::GetListArraySize(const unsigned long subField, const unsigned long listIndex, const unsigned long listField)
    {
    switch(subField)
        {
        case 17: //factions
...
void NPC_Record::GetListArray(const unsigned long subField, const unsigned long listIndex, const unsigned long listField, void **FieldValues)
    {
    switch(subField)
        {
        case 17: //factions
...
void * NPC_Record::GetListField(const unsigned long subField, const unsigned long listIndex, const unsigned long listField)
    {
    switch(subField)
        {
        case 17: //factions
...
void NPC_Record::SetField(const unsigned long Field, char *FieldValue)
    {
    switch(Field)
        {
        case 5: //eid
...
void NPC_Record::SetField(const unsigned long Field, float FieldValue)
    {
    switch(Field)
        {
        case 8: //modb
...
void NPC_Record::SetField(const unsigned long Field, unsigned char *FieldValue, unsigned long nSize)
    {
    switch(Field)
        {
        case 9: //modt_p
...
void NPC_Record::SetOtherField(const unsigned long Field, unsigned long FieldValue)
    {
    switch(Field)
        {
        case 10: //flags
...
void NPC_Record::SetField(const unsigned long Field, unsigned short FieldValue)
    {
    switch(Field)
        {
        case 11: //baseSpell
...
void NPC_Record::SetField(const unsigned long Field, short FieldValue)
    {
    switch(Field)
        {
        case 14: //level
...
void NPC_Record::SetListField(const unsigned long subField, const unsigned long listIndex, const unsigned long listField, unsigned long FieldValue)
    {
    switch(subField)
        {
        case 17: //factions
...
void NPC_Record::SetListField(const unsigned long subField, const unsigned long listIndex, const unsigned long listField, unsigned char FieldValue)
    {
    switch(subField)
        {
        case 17: //factions
...
void NPC_Record::SetListField(const unsigned long subField, const unsigned long listIndex, const unsigned long listField, signed long FieldValue)
    {
    switch(subField)
        {
        case 22: //items
...
void NPC_Record::SetListField(const unsigned long subField, const unsigned long listIndex, const unsigned long listField, unsigned char *FieldValue, unsigned long nSize)
    {
    switch(subField)
        {
        case 17: //factions
...
void NPC_Record::SetField(const unsigned long Field, unsigned long FieldValue[], unsigned long nSize)
    {
    switch(Field)
        {
        case 20: //spells
...
void NPC_Record::SetField(const unsigned long Field, unsigned char FieldValue)
    {
    switch(Field)
        {
        case 23: //aggression
...
void NPC_Record::SetField(const unsigned long Field, char **FieldValue, unsigned long nSize)
    {
    switch(Field)
        {
        case 32: //animations
...
signed long NPC_Record::DeleteField(const unsigned long Field)
    {
    GENAIDT defaultAIDT;
    GENACBS defaultACBS;
...
signed long NPC_Record::DeleteListField(const unsigned long subField, const unsigned long listIndex, const unsigned long listField)
    {
    GENSNAM defaultSNAM;
    GENCNTO defaultCNTO;
    switch(subField)
