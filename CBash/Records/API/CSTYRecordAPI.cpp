...
signed long CSTYRecord::GetOtherFieldType(const unsigned long Field)
    {
    switch(Field)
        {
        case 6: //dodgeChance
...
void * CSTYRecord::GetOtherField(const unsigned long Field)
    {
    switch(Field)
        {
        case 5: //eid
...
unsigned long CSTYRecord::GetFieldArraySize(const unsigned long Field)
    {
    switch(Field)
        {
        case 8: //unused1
...
void CSTYRecord::GetFieldArray(const unsigned long Field, void **FieldValues)
    {
    switch(Field)
        {
        case 8: //unused1
...
void CSTYRecord::SetField(const unsigned long Field, char *FieldValue)
    {
    switch(Field)
        {
        case 5: //eid
...
void CSTYRecord::SetField(const unsigned long Field, unsigned char FieldValue)
    {
    switch(Field)
        {
        case 6: //dodgeChance
...
void CSTYRecord::SetField(const unsigned long Field, unsigned char *FieldValue, unsigned long nSize)
    {
    switch(Field)
        {
        case 8: //unused1
...
void CSTYRecord::SetField(const unsigned long Field, float FieldValue)
    {
    switch(Field)
        {
        case 9: //lrTimerMin
...
void CSTYRecord::SetOtherField(const unsigned long Field, unsigned long FieldValue)
    {
    switch(Field)
        {
        case 48: //flagsB
...
signed long CSTYRecord::DeleteField(const unsigned long Field)
    {
