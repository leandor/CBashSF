...
signed long TES4Record::GetOtherFieldType(const unsigned long Field)
    {
    switch(Field)
        {
        case 6: //version
...
void * TES4Record::GetOtherField(const unsigned long Field)
    {
    switch(Field)
        {
...
void TES4Record::SetField(const unsigned long Field, char **FieldValue, unsigned long nSize)
    {
    switch(Field)
        {
        case 13: //masters
...
void TES4Record::SetField(const unsigned long Field, unsigned char *FieldValue, unsigned long nSize)
    {
    switch(Field)
        {
        case 9: //ofst_p
...
void TES4Record::SetField(const unsigned long Field, float FieldValue)
    {
    switch(Field)
        {
        case 6: //version
...
void TES4Record::SetOtherField(const unsigned long Field, unsigned long FieldValue)
    {
    switch(Field)
        {
        case 7: //numRecords
...
void TES4Record::SetField(const unsigned long Field, char *FieldValue)
    {
    switch(Field)
        {
        //case 5: //eid, not present on TES4
...
unsigned long TES4Record::GetFieldArraySize(const unsigned long Field)
    {
    switch(Field)
        {
        case 9: //ofst_p
        ...
        case 10: //dele_p
            return DELE.GetSize();
        case 13: //masters
            return (unsigned long)MAST.size();
        default:
            return 0;
        }
    }

void TES4Record::GetFieldArray(const unsigned long Field, void **FieldValues)
    {
    switch(Field)
        {
        case 9: //ofst_p
            *FieldValues = OFST.value;
            ...
            //for(unsigned long x = 0; x < OFST.size; x++)
...
signed long TES4Record::DeleteField(const unsigned long Field)
    {
