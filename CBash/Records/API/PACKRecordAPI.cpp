...
signed long PACKRecord::CreateListElement(const unsigned long subField)
    {
...
signed long PACKRecord::DeleteListElement(const unsigned long subField)
    {
    ReqSubRecord<GENCTDA> *curCTDA = NULL;
    switch(subField)
        {
...
signed long PACKRecord::GetOtherFieldType(const unsigned long Field)
    {
    switch(Field)
        {
        case 6: //flags
...
void * PACKRecord::GetOtherField(const unsigned long Field)
    {
    switch(Field)
        {
        case 5: //eid
...
unsigned long PACKRecord::GetFieldArraySize(const unsigned long Field)
    {
    switch(Field)
        {
        case 8: //unused1
...
void PACKRecord::GetFieldArray(const unsigned long Field, void **FieldValues)
    {
    switch(Field)
        {
        case 8: //unused1
...
signed long PACKRecord::GetListFieldType(const unsigned long subField, const unsigned long listField)
    {
    switch(subField)
        {
        case 20: //conditions
...
unsigned long PACKRecord::GetListSize(const unsigned long Field)
    {
    switch(Field)
        {
        case 20: //conditions
...
unsigned long PACKRecord::GetListArraySize(const unsigned long subField, const unsigned long listIndex, const unsigned long listField)
    {
    switch(subField)
        {
        case 20: //conditions
...
void PACKRecord::GetListArray(const unsigned long subField, const unsigned long listIndex, const unsigned long listField, void **FieldValues)
    {
    switch(subField)
        {
        case 20: //conditions
...
void * PACKRecord::GetListField(const unsigned long subField, const unsigned long listIndex, const unsigned long listField)
    {
    switch(subField)
        {
        case 20: //conditions
...
void PACKRecord::SetField(const unsigned long Field, char *FieldValue)
    {
    switch(Field)
        {
        case 5: //eid
...
void PACKRecord::SetOtherField(const unsigned long Field, unsigned long FieldValue)
    {
    switch(Field)
        {
        case 6: //flags
...
void PACKRecord::SetField(const unsigned long Field, unsigned char FieldValue)
    {
    switch(Field)
        {
        case 7: //aiType
...
void PACKRecord::SetField(const unsigned long Field, unsigned char *FieldValue, unsigned long nSize)
    {
    switch(Field)
        {
        case 8: //unused1
...
void PACKRecord::SetField(const unsigned long Field, signed long FieldValue)
    {
    switch(Field)
        {
        case 9: //locType
...
void PACKRecord::SetListField(const unsigned long subField, const unsigned long listIndex, const unsigned long listField, unsigned char FieldValue)
    {
    switch(subField)
        {
        case 20: //conditions
...
void PACKRecord::SetListField(const unsigned long subField, const unsigned long listIndex, const unsigned long listField, unsigned char *FieldValue, unsigned long nSize)
    {
    switch(subField)
        {
        case 20: //conditions
...
void PACKRecord::SetListField(const unsigned long subField, const unsigned long listIndex, const unsigned long listField, float FieldValue)
    {
    switch(subField)
        {
        case 20: //conditions
...
void PACKRecord::SetListField(const unsigned long subField, const unsigned long listIndex, const unsigned long listField, unsigned long FieldValue)
    {
    switch(subField)
        {
        case 20: //conditions
...
signed long PACKRecord::DeleteField(const unsigned long Field)
    {
...
signed long PACKRecord::DeleteListField(const unsigned long subField, const unsigned long listIndex, const unsigned long listField)
    {
    GENCTDA defaultCTDA;
    switch(subField)
        {
