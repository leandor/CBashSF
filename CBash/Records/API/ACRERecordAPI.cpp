...
signed long ACRERecord::GetOtherFieldType(const unsigned long Field)
    {
    switch(Field)
        {
        case 6: //base
...
void * ACRERecord::GetOtherField(const unsigned long Field)
    {
    switch(Field)
        {
        case 5: //eid
...
unsigned long ACRERecord::GetFieldArraySize(const unsigned long Field)
    {
    switch(Field)
        {
        case 15: //unused1
...
void ACRERecord::GetFieldArray(const unsigned long Field, void **FieldValues)
    {
    switch(Field)
        {
        case 15: //unused1
...
void ACRERecord::SetField(const unsigned long Field, char *FieldValue)
    {
    switch(Field)
        {
        case 5: //eid
...
void ACRERecord::SetOtherField(const unsigned long Field, unsigned long FieldValue)
    {
    switch(Field)
        {
        case 6: //base
...
void ACRERecord::SetField(const unsigned long Field, signed long FieldValue)
    {
    switch(Field)
        {
        case 8: //rank
...
void ACRERecord::SetField(const unsigned long Field, unsigned char FieldValue)
    {
    switch(Field)
        {
        case 14: //parentFlags
...
void ACRERecord::SetField(const unsigned long Field, unsigned char *FieldValue, unsigned long nSize)
    {
    switch(Field)
        {
        case 15: //unused1
...
void ACRERecord::SetField(const unsigned long Field, float FieldValue)
    {
    switch(Field)
        {
        case 10: //lod1
...
signed long ACRERecord::DeleteField(const unsigned long Field)
    {
    GENXLOD defaultXLOD;
    GENXESP defaultXESP;
