...
signed long CLASRecord::GetOtherFieldType(const unsigned long Field)
    {
    switch(Field)
        {
        case 6: //full
...
void * CLASRecord::GetOtherField(const unsigned long Field)
    {
    switch(Field)
        {
        case 5: //eid
...
unsigned long CLASRecord::GetFieldArraySize(const unsigned long Field)
    {
    switch(Field)
        {
        case 23: //unused1
...
void CLASRecord::GetFieldArray(const unsigned long Field, void **FieldValues)
    {
    switch(Field)
        {
        case 23: //unused1
...
void CLASRecord::SetField(const unsigned long Field, char *FieldValue)
    {
    switch(Field)
        {
        case 5: //eid
...
void CLASRecord::SetField(const unsigned long Field, signed long FieldValue)
    {
    switch(Field)
        {
        case 9: //primary1
...
void CLASRecord::SetOtherField(const unsigned long Field, unsigned long FieldValue)
    {
    switch(Field)
        {
        case 11: //specialization
...
void CLASRecord::SetField(const unsigned long Field, unsigned char FieldValue)
    {
    switch(Field)
        {
        case 22: //trainLevel
...
void CLASRecord::SetField(const unsigned long Field, unsigned char *FieldValue, unsigned long nSize)
    {
    switch(Field)
        {
        case 23: //unused1
...
signed long CLASRecord::DeleteField(const unsigned long Field)
    {
