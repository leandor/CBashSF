...
signed long ENCHRecord::CreateListElement(const unsigned long subField)
    {
...
signed long ENCHRecord::DeleteListElement(const unsigned long subField)
    {
    GENEffect *curEffect = NULL;
    switch(subField)
        {
...
signed long ENCHRecord::GetOtherFieldType(const unsigned long Field)
    {
    switch(Field)
        {
        case 6: //full
...
void * ENCHRecord::GetOtherField(const unsigned long Field)
    {
    switch(Field)
        {
        case 5: //eid
...
unsigned long ENCHRecord::GetFieldArraySize(const unsigned long Field)
    {
    switch(Field)
        {
        case 11: //unused1
...
void ENCHRecord::GetFieldArray(const unsigned long Field, void **FieldValues)
    {
    switch(Field)
        {
        case 11: //unused1
...
signed long ENCHRecord::GetListFieldType(const unsigned long subField, const unsigned long listField)
    {
    switch(subField)
        {
        case 12: //Effects
...
unsigned long ENCHRecord::GetListSize(const unsigned long Field)
    {
    switch(Field)
        {
        case 12: //Effects
...
unsigned long ENCHRecord::GetListArraySize(const unsigned long subField, const unsigned long listIndex, const unsigned long listField)
    {
    switch(subField)
        {
        case 12: //Effects
...
void ENCHRecord::GetListArray(const unsigned long subField, const unsigned long listIndex, const unsigned long listField, void **FieldValues)
    {
    switch(subField)
        {
        case 12: //Effects
...
void * ENCHRecord::GetListField(const unsigned long subField, const unsigned long listIndex, const unsigned long listField)
    {
    switch(subField)
        {
        case 12: //Effects
...
void ENCHRecord::SetField(const unsigned long Field, char *FieldValue)
    {
    switch(Field)
        {
        case 5: //eid
...
void ENCHRecord::SetOtherField(const unsigned long Field, unsigned long FieldValue)
    {
    switch(Field)
        {
        case 7: //itemType
...
void ENCHRecord::SetField(const unsigned long Field, unsigned char FieldValue)
    {
    switch(Field)
        {
        case 10: //flags
...
void ENCHRecord::SetField(const unsigned long Field, unsigned char *FieldValue, unsigned long nSize)
    {
    switch(Field)
        {
        case 11: //unused1
...
void ENCHRecord::SetListField(const unsigned long subField, const unsigned long listIndex, const unsigned long listField, unsigned long FieldValue)
    {
    switch(subField)
        {
        case 12: //Effects
...
void ENCHRecord::SetListField(const unsigned long subField, const unsigned long listIndex, const unsigned long listField, float FieldValue)
    {
    switch(subField)
        {
        case 12: //Effects
...
void ENCHRecord::SetListField(const unsigned long subField, const unsigned long listIndex, const unsigned long listField, unsigned char FieldValue)
    {
    switch(subField)
        {
        case 12: //Effects
...
void ENCHRecord::SetListField(const unsigned long subField, const unsigned long listIndex, const unsigned long listField, unsigned char *FieldValue, unsigned long nSize)
    {
    switch(subField)
        {
        case 12: //Effects
...
void ENCHRecord::SetListField(const unsigned long subField, const unsigned long listIndex, const unsigned long listField, char *FieldValue)
    {
    switch(subField)
        {
        case 12: //Effects
...
signed long ENCHRecord::DeleteField(const unsigned long Field)
    {
...
signed long ENCHRecord::DeleteListField(const unsigned long subField, const unsigned long listIndex, const unsigned long listField)
    {
    GENEFIT defaultEFIT;
    GENSCIT defaultSCIT;
