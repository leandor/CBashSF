...
signed long REFRRecord::GetOtherFieldType(const unsigned long Field)
    {
    switch(Field)
        {
        case 6: //base
...
void * REFRRecord::GetOtherField(const unsigned long Field)
    {
    switch(Field)
        {
        case 5: //eid
...
unsigned long REFRRecord::GetFieldArraySize(const unsigned long Field)
    {
    switch(Field)
        {
        case 15: //unused1
...
void REFRRecord::GetFieldArray(const unsigned long Field, void **FieldValues)
    {
    switch(Field)
        {
        case 15: //unused1
...
void REFRRecord::SetField(const unsigned long Field, char *FieldValue)
    {
    switch(Field)
        {
        case 5: //eid
...
void REFRRecord::SetOtherField(const unsigned long Field, unsigned long FieldValue)
    {
    switch(Field)
        {
        case 6: //base
...
void REFRRecord::SetField(const unsigned long Field, float FieldValue)
    {
    switch(Field)
        {
        case 8: //destinationPosX
...
void REFRRecord::SetField(const unsigned long Field, unsigned char FieldValue)
    {
    switch(Field)
        {
        case 14: //lockLevel
...
void REFRRecord::SetField(const unsigned long Field, unsigned char *FieldValue, unsigned long nSize)
    {
    switch(Field)
        {
        case 15: //unused1
...
void REFRRecord::SetField(const unsigned long Field, signed long FieldValue)
    {
    switch(Field)
        {
        case 21: //rank
...
signed long REFRRecord::DeleteField(const unsigned long Field)
    {
