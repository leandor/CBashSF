...
signed long EFSHRecord::GetOtherFieldType(const unsigned long Field)
    {
    switch(Field)
        {
        case 6: //fillTexture
...
void * EFSHRecord::GetOtherField(const unsigned long Field)
    {
    switch(Field)
        {
        case 5: //eid
...
unsigned long EFSHRecord::GetFieldArraySize(const unsigned long Field)
    {
    switch(Field)
        {
        case 9: //unused1
...
void EFSHRecord::GetFieldArray(const unsigned long Field, void **FieldValues)
    {
    switch(Field)
        {
        case 9: //unused1
...
void EFSHRecord::SetField(const unsigned long Field, char *FieldValue)
    {
    switch(Field)
        {
        case 5: //eid
...
void EFSHRecord::SetField(const unsigned long Field, unsigned char FieldValue)
    {
    switch(Field)
        {
        case 8: //flags
...
void EFSHRecord::SetField(const unsigned long Field, unsigned char *FieldValue, unsigned long nSize)
    {
    switch(Field)
        {
        case 9: //unused1
...
void EFSHRecord::SetOtherField(const unsigned long Field, unsigned long FieldValue)
    {
    switch(Field)
        {
        case 10: //memSBlend
...
void EFSHRecord::SetField(const unsigned long Field, float FieldValue)
    {
    switch(Field)
        {
        case 17: //fillAIn
...
signed long EFSHRecord::DeleteField(const unsigned long Field)
    {
