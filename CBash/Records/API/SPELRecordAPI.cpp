...
signed long SPELRecord::CreateListElement(const unsigned long subField)
    {
...
signed long SPELRecord::DeleteListElement(const unsigned long subField)
    {
    GENEffect *curEffect = NULL;
    switch(subField)
        {
...
signed long SPELRecord::GetOtherFieldType(const unsigned long Field)
    {
    switch(Field)
        {
        case 6: //full
...
void * SPELRecord::GetOtherField(const unsigned long Field)
    {
    switch(Field)
        {
        case 5: //eid
...
unsigned long SPELRecord::GetFieldArraySize(const unsigned long Field)
    {
    switch(Field)
        {
        case 11: //unused1
...
void SPELRecord::GetFieldArray(const unsigned long Field, void **FieldValues)
    {
    switch(Field)
        {
        case 11: //unused1
...
signed long SPELRecord::GetListFieldType(const unsigned long subField, const unsigned long listField)
    {
    switch(subField)
        {
        case 12: //Effects
...
unsigned long SPELRecord::GetListSize(const unsigned long Field)
    {
    switch(Field)
        {
        case 12: //Effects
...
unsigned long SPELRecord::GetListArraySize(const unsigned long subField, const unsigned long listIndex, const unsigned long listField)
    {
    switch(subField)
        {
        case 12: //Effects
...
void SPELRecord::GetListArray(const unsigned long subField, const unsigned long listIndex, const unsigned long listField, void **FieldValues)
    {
    switch(subField)
        {
        case 12: //Effects
...
void * SPELRecord::GetListField(const unsigned long subField, const unsigned long listIndex, const unsigned long listField)
    {
    switch(subField)
        {
        case 12: //Effects
...
void SPELRecord::SetField(const unsigned long Field, char *FieldValue)
    {
    switch(Field)
        {
        case 5: //eid
...
void SPELRecord::SetOtherField(const unsigned long Field, unsigned long FieldValue)
    {
    switch(Field)
        {
        case 7: //spellType
...
void SPELRecord::SetField(const unsigned long Field, unsigned char FieldValue)
    {
    switch(Field)
        {
        case 10: //flags
...
void SPELRecord::SetField(const unsigned long Field, unsigned char *FieldValue, unsigned long nSize)
    {
    switch(Field)
        {
        case 11: //unused1
...
void SPELRecord::SetListField(const unsigned long subField, const unsigned long listIndex, const unsigned long listField, unsigned long FieldValue)
    {
    switch(subField)
        {
        case 12: //Effects
...
void SPELRecord::SetListField(const unsigned long subField, const unsigned long listIndex, const unsigned long listField, unsigned char FieldValue)
    {
    switch(subField)
        {
        case 12: //Effects
...
void SPELRecord::SetListField(const unsigned long subField, const unsigned long listIndex, const unsigned long listField, float FieldValue)
    {
    switch(subField)
        {
        case 12: //Effects
...
void SPELRecord::SetListField(const unsigned long subField, const unsigned long listIndex, const unsigned long listField, unsigned char *FieldValue, unsigned long nSize)
    {
    switch(subField)
        {
        case 12: //Effects
...
void SPELRecord::SetListField(const unsigned long subField, const unsigned long listIndex, const unsigned long listField, char *FieldValue)
    {
    switch(subField)
        {
        case 12: //Effects
...
signed long SPELRecord::DeleteField(const unsigned long Field)
    {
...
signed long SPELRecord::DeleteListField(const unsigned long subField, const unsigned long listIndex, const unsigned long listField)
    {
    GENEFIT defaultEFIT;
    GENSCIT defaultSCIT;
