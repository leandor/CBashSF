...
signed long CLOTRecord::GetOtherFieldType(const unsigned long Field)
    {
    switch(Field)
        {
        case 6: //full
...
void * CLOTRecord::GetOtherField(const unsigned long Field)
    {
    switch(Field)
        {
        case 5: //eid
...
unsigned long CLOTRecord::GetFieldArraySize(const unsigned long Field)
    {
    switch(Field)
        {
        case 13: //maleBody_modt_p
...
void CLOTRecord::GetFieldArray(const unsigned long Field, void **FieldValues)
    {
    switch(Field)
        {
        case 13: //maleBody_modt_p
...
void CLOTRecord::SetField(const unsigned long Field, char *FieldValue)
    {
    switch(Field)
        {
        case 5: //eid
...
void CLOTRecord::SetOtherField(const unsigned long Field, unsigned long FieldValue)
    {
    switch(Field)
        {
        case 7: //script
...
void CLOTRecord::SetField(const unsigned long Field, unsigned short FieldValue)
    {
    switch(Field)
        {
        case 9: //enchantPoints
...
void CLOTRecord::SetField(const unsigned long Field, float FieldValue)
    {
    switch(Field)
        {
        case 12: //maleBody_modb
...
void CLOTRecord::SetField(const unsigned long Field, unsigned char *FieldValue, unsigned long nSize)
    {
    switch(Field)
        {
        case 13: //maleBody_modt_p
...
signed long CLOTRecord::DeleteField(const unsigned long Field)
    {
