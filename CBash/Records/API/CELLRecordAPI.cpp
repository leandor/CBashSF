...
signed long CELLRecord::GetOtherFieldType(const unsigned long Field)
    {
    switch(Field)
        {
        case 6: //full
...
void * CELLRecord::GetOtherField(const unsigned long Field)
    {
    switch(Field)
        {
        case 5: //eid
...
unsigned long CELLRecord::GetFieldArraySize(const unsigned long Field)
    {
    switch(Field)
        {
        case 11: //unused1
        ...
        case 19: //unused3
            ...
            return 0;
        case 36: //ACHR
            return (unsigned long)ACHR.size();
        case 37: //ACRE
            return (unsigned long)ACRE.size();
        case 38: //REFR
            return (unsigned long)REFR.size();
        default:
            return 0;
        }
    }

void CELLRecord::GetFieldArray(const unsigned long Field, void **FieldValues)
    {
    switch(Field)
        {
        case 11: //unused1
        ...
        case 32: //regions
            ...
            return;
        case 36: //ACHR
            for(unsigned long p = 0;p < ACHR.size();p++)
                FieldValues[p] = &ACHR[p]->formID;
            return;
        case 37: //ACRE
            for(unsigned long p = 0;p < ACRE.size();p++)
                FieldValues[p] = &ACRE[p]->formID;
            return;
        case 38: //REFR
            for(unsigned long p = 0;p < REFR.size();p++)
...
void CELLRecord::SetField(const unsigned long Field, char *FieldValue)
    {
    switch(Field)
        {
        case 5: //eid
...
void CELLRecord::SetField(const unsigned long Field, unsigned char FieldValue)
    {
    switch(Field)
        {
        case 7: //flags
...
void CELLRecord::SetField(const unsigned long Field, unsigned char *FieldValue, unsigned long nSize)
    {
    switch(Field)
        {
        case 11: //unused1
...
void CELLRecord::SetField(const unsigned long Field, float FieldValue)
    {
    switch(Field)
        {
        case 20: //fogNear
...
void CELLRecord::SetField(const unsigned long Field, signed long FieldValue)
    {
    switch(Field)
        {
        case 22: //directionalXY
...
void CELLRecord::SetOtherField(const unsigned long Field, unsigned long FieldValue)
    {
    switch(Field)
        {
        case 27: //owner
...
void CELLRecord::SetField(const unsigned long Field, unsigned long FieldValue[], unsigned long nSize)
    {
    switch(Field)
        {
        case 32: //regions
...
signed long CELLRecord::DeleteField(const unsigned long Field)
    {
