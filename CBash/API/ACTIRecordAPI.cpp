...
int ACTIRecord::GetOtherFieldType(const unsigned int Field)
    {
    switch(Field)
        {
        case 6: //full
...
void * ACTIRecord::GetOtherField(const unsigned int Field)
    {
    switch(Field)
        {
        case 5: //eid
...
unsigned int ACTIRecord::GetFieldArraySize(const unsigned int Field)
    {
    switch(Field)
        {
        case 9: //modt_p
...
void ACTIRecord::GetFieldArray(const unsigned int Field, void **FieldValues)
    {
    switch(Field)
        {
        case 9: //modt_p
...
int ACTIRecord::DeleteField(const unsigned int Field)
    {
    switch(Field)
        {
        case 5: //eid
