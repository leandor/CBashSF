...
int WRLDRecord::GetOtherFieldType(const unsigned int Field)
    {
    switch(Field)
        {
        case 6: //full
...
void * WRLDRecord::GetOtherField(const unsigned int Field)
    {
    switch(Field)
        {
        case 5: //eid
...
unsigned int WRLDRecord::GetFieldArraySize(const unsigned int Field)
    {
    switch(Field)
        {
        case 23: //ofst_p
...
void WRLDRecord::GetFieldArray(const unsigned int Field, void **FieldValues)
    {
    switch(Field)
        {
        case 23: //ofst_p
            *FieldValues = OFST.value;
            return;
        case 26: //CELLS
            for(unsigned int p = 0;p < CELLS.size();p++)
