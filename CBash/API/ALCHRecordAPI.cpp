...
void ALCHRecord::SetField(const unsigned int Field, char *FieldValue)
    {
    switch(Field)
        {
        case 5: //eid
...
void ALCHRecord::SetField(const unsigned int Field, float FieldValue)
    {
    switch(Field)
        {
        case 8: //modb
...
void ALCHRecord::SetField(const unsigned int Field, unsigned char *FieldValue, unsigned int nSize)
    {
    switch(Field)
        {
        case 9: //modt_p
...
void ALCHRecord::SetOtherField(const unsigned int Field, unsigned int FieldValue)
    {
    switch(Field)
        {
        case 11: //script
...
void ALCHRecord::SetField(const unsigned int Field, int FieldValue)
    {
    switch(Field)
        {
        case 13: //value
...
void ALCHRecord::SetField(const unsigned int Field, unsigned char FieldValue)
    {
    switch(Field)
        {
        case 14: //flags
...
void ALCHRecord::SetListField(const unsigned int subField, const unsigned int listIndex, const unsigned int listField, unsigned int FieldValue)
    {
    switch(subField)
        {
        case 16: //Effects
...
void ALCHRecord::SetListField(const unsigned int subField, const unsigned int listIndex, const unsigned int listField, float FieldValue)
    {
    switch(subField)
        {
        case 16: //Effects
...
void ALCHRecord::SetListField(const unsigned int subField, const unsigned int listIndex, const unsigned int listField, unsigned char FieldValue)
    {
    switch(subField)
        {
        case 16: //Effects
...
void ALCHRecord::SetListField(const unsigned int subField, const unsigned int listIndex, const unsigned int listField, unsigned char *FieldValue, unsigned int nSize)
    {
    switch(subField)
        {
        case 16: //Effects
...
void ALCHRecord::SetListField(const unsigned int subField, const unsigned int listIndex, const unsigned int listField, char *FieldValue)
    {
    switch(subField)
        {
        case 16: //Effects
...
int ALCHRecord::DeleteField(const unsigned int Field)
    {
    GENENIT defaultENIT;
...
int ALCHRecord::DeleteListField(const unsigned int subField, const unsigned int listIndex, const unsigned int listField)
    {
    GENEFIT defaultEFIT;
    GENSCIT defaultSCIT;
