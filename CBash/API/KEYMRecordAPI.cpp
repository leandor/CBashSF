...
int KEYMRecord::GetOtherFieldType(const unsigned int Field)
    {
    switch(Field)
        {
        case 6: //full
...
void * KEYMRecord::GetOtherField(const unsigned int Field)
    {
    switch(Field)
        {
        case 5: //eid
...
unsigned int KEYMRecord::GetFieldArraySize(const unsigned int Field)
    {
    switch(Field)
        {
        case 9: //modt_p
...
void KEYMRecord::GetFieldArray(const unsigned int Field, void **FieldValues)
    {
    switch(Field)
        {
        case 9: //modt_p
...
int KEYMRecord::DeleteField(const unsigned int Field)
    {
