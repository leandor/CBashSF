...
int LVSPRecord::CreateListElement(const unsigned int subField)
    {
...
int LVSPRecord::DeleteListElement(const unsigned int subField)
    {
    ReqSubRecord<LVLLVLO> *curEntry = NULL;
    switch(subField)
        {
...
int LVSPRecord::GetOtherFieldType(const unsigned int Field)
    {
    switch(Field)
        {
        case 6: //chanceNone
...
void * LVSPRecord::GetOtherField(const unsigned int Field)
    {
    switch(Field)
        {
        case 5: //eid
...
int LVSPRecord::GetListFieldType(const unsigned int subField, const unsigned int listField)
    {
    switch(subField)
        {
        case 10: //entries
...
unsigned int LVSPRecord::GetListSize(const unsigned int Field)
    {
    switch(Field)
        {
        case 10: //entries
...
unsigned int LVSPRecord::GetListArraySize(const unsigned int subField, const unsigned int listIndex, const unsigned int listField)
    {
    switch(subField)
        {
        case 10: //entries
...
void LVSPRecord::GetListArray(const unsigned int subField, const unsigned int listIndex, const unsigned int listField, void **FieldValues)
    {
    switch(subField)
        {
        case 10: //entries
...
void * LVSPRecord::GetListField(const unsigned int subField, const unsigned int listIndex, const unsigned int listField)
    {
    switch(subField)
        {
        case 10: //entries
