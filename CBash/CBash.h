...
extern "C" __declspec(dllexport) unsigned int CreateCELLRecord(const unsigned int CollectionIndex, char *ModName, unsigned int parentFID);
...
extern "C" __declspec(dllexport) unsigned int CopyCELLRecord(const unsigned int CollectionIndex, char *ModName, unsigned int srcRecordFID, char *destModName, unsigned int destParentFID, bool asOverride);
