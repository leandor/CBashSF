...
class ObModFile(object):
    ...
    ObModRecordsMACRO(ACHR)
    ObModRecordsMACRO(ACRE)
    ObModRecordsMACRO(REFR)
    ObModRecordsMACRO(PGRD)
    ObModRecordsMACRO(LAND)
    ObModRecordsMACRO(ROAD)
    ObModRecordsMACRO(DIAL)
    ObModRecordsMACRO(INFO)
